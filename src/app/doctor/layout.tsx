...
import { LayoutDashboard, Users, Clock, Stethoscope } from 'lucide-react';
      ...
      <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col hidden md:flex fixed h-full z-20">
        ...
        <div className="px-6 py-4 border-b border-slate-800">
          ...
          <div className="text-sm font-medium text-white flex items-center gap-2">
            <div className="w-2 h-2 rounded-full bg-emerald-500"></div> Remote Doctor
          </div>
        </div>
        
        <nav className="flex-1 py-6 px-4 space-y-2">
          <Link href="/doctor" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 hover:text-white transition-colors">
            <LayoutDashboard className="w-5 h-5" /> Case Queue
          </Link>
          <Link href="/doctor/patients" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 hover:text-white transition-colors">
            <Users className="w-5 h-5" /> Patients
          </Link>
          <Link href="/doctor/follow-ups" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-slate-800 hover:text-white transition-colors">
